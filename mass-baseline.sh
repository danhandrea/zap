...
git config --global user.email "handrea.dan@gmail.com"
git config --global user.name "Dan Handrea"
user="danhandrea"
repo="zap"
...
./mass-basewrapper.sh $repo.wiki devuat.dental-directory.co.uk / https://devuat.dental-directory.co.uk
